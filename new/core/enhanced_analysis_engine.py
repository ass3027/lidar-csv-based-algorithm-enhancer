#!/usr/bin/env python3
"""Enhanced analysis engine with time-of-day and queue growth adjustments"""
...
def analyze_with_enhancements(data, model_dir='models'):
    ...
    for alg in ['lidarEstTime', 'throughputEstTime', 'finalEstTime']:
        ...
        improvement_pct = ((original_mae - enhanced_mae) / original_mae) * 100 if original_mae > 0 else 0
